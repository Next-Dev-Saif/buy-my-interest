    ...
    <header className="sticky top-0 z-50 w-full glass border-b border-white/5">
      <Container className="h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <ThemeToggle />
          <Link href="/get-started" className="px-5 py-2 text-sm font-semibold rounded-lg bg-primary text-primary-foreground hover:bg-primary/90 transition-colors shadow-sm">
            Get Started
          </Link>
        </div>
      </Container>
