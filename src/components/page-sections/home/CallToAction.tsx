        ...
        >
          ...
          <div className="relative z-10 text-center space-y-8 md:space-y-10 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center pt-4 md:pt-6">
              <Link href="/get-started" className="group w-full sm:w-auto px-8 md:px-12 py-4 md:py-5 rounded-2xl bg-background text-foreground font-black text-base md:text-lg hover:bg-background/90 hover:shadow-2xl transition-all flex items-center justify-center gap-3 active:scale-95">
                 Initialize My Search <ArrowRight className="w-5 h-5 text-primary group-hover:translate-x-1 transition-transform" />
              </Link>
              <Link href="/seller" className="w-full sm:w-auto px-8 md:px-12 py-4 md:py-5 rounded-2xl border border-primary-foreground/30 text-primary-foreground font-bold text-base md:text-lg hover:bg-white/10 transition-all flex items-center justify-center gap-3 backdrop-blur-sm">
