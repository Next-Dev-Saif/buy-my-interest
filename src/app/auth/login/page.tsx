  ...
  return (
    <div className="glass-dark p-8 md:p-10 rounded-[2.5rem] space-y-8 relative overflow-hidden group shadow-2xl">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex justify-between items-center ml-1">
              <label className="text-xs font-black uppercase tracking-[0.2em] text-secondary">Password</label>
      ...
      <p className="text-center text-[11px] font-bold text-muted-foreground relative">
        ...
        <Link href="/auth/signup" className="text-primary hover:underline uppercase tracking-widest ml-1">
          Sign up
        </Link>
      </p>
    </div>
